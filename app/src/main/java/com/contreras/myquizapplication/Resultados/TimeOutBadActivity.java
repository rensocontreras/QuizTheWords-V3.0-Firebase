...
public class TimeOutBadActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_time_out_bad);
        ButterKnife.bind(this);
    }

    @OnClick(R.id.btn_siguiente)
    public void siguiente(){
        Intent intent =new Intent(TimeOutBadActivity.this, JugarActivity.class);
